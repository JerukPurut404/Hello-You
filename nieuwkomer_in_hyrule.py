...
def end_database():
	list = [str(naam), str(landgoed), str(weapon), str(dorp), str(rupee), str(ending_story), str(reason_story)]
...
def game_over(ending, reason):
	global ending_story
	global reason_story
	ending_story.append(ending)
	reason_story.append(reason)
	end_database()
	print("\n" + ending)
	print("\n" + reason)
	print("Game Over!")
...
--------------------
	...
	if option == "1":
		...
		print(
			"Jouw wapen is " + weapon[0], "en jouw wapen sterkte is " + str(weapon[1])
		)
		end_database()
		sleep(5)
		os.system("cls")
...
def enemy_incoming_high_ground():
	...
	print(
		"Jij komt gemeene bokoblins tegen met de health van " + str(bokolins),
		". Ze komen dichterbij naar je richting toe. Je hebt je wapen bij je. Wat zou je doen? A. Vechten, B. Rennen, C.Schreeuwen",
	)
...
def enemy_incoming_fp():
	...
	os.system("cls")
	print(
		"Jij wilt even rusten in de pond en ga een beetje zwemmen maar je komt lizalfos tegen met de health van "
		+ str(lizalfos),
		". Wat zou je doen? A. Vechten, B. Rennen, C.Schreeuwen",
	)
	option = input(">")
	if option in answer_A:
...
def enemy_incoming_zp():
	...
	print(
		"Jij wilt even rusten in de pond en ga een beetje zwemmen maar je komt lizalfos tegen met de health van "
		+ str(lizalfos),
		". Je kijkt even naar links en je vindt een roestig slagzwaard. A. Vechten met je huidige wapen, B. Vechten met roestige slagzwaard, C.Schreeuwen",
	)
	option = input(">")
	if option in answer_A:
		if weapon[1] > lizalfos:
		...
		if weapon[3] > lizalfos:
			...
			game_over(
				"Bad ending",
				"Helaas is je roestige slagzwaard niet sterk genoeg om te vechten",
			)
	elif option in answer_C:
		os.system("cls")
		game_over("Bad ending", "Jij hebt gekozen voor Schreeuwen maar dat helpt niet")
...
def story_nachtronde():
	print(
		"Jij heeft gevochten en het is je gelukt om hun te doden. Je vertelt de mensen over de gebeurtenis. Ze zeggen dat ze zal een Nachtrondes gehouden en ze kozen je om te doen. Wat zou je zeggen?"
	)
...
def story_rennen():
	print(
		"jij rent naar Hateno Ancient Tech Lab en ze zeggen dat ze kan een harnas bouwen maar als je een moer kunnen vinden en daarna kun je werken aan Nachtrondes. Wat zou je doen?"
	)
...
def option_roestig_slagzwaard():
	print(
		"Jij vecht maar je breek je zwaard. Je bent naar de mensen te vragen of ze een nieuwe wapen kunnen maken. Een wapenmaker zegt dat hij kan je een nieuwe zwaard maken maar je moet de nachtrondes doen. Wat zou je zeggen?"
	)
...
def option_giveup():
	...
	game_over(
		"Neutral Ending",
		"Je gave de werk aan iemand anders. Uiteindelijk je hebt krijg werk in verfwinkel en een huis.",
	)
...
def option_work_nachtrondes_zonder_harnas():
	...
	game_over(
		"Bad ending",
		"Je hebt helaas moeten veel monster slachten in de nacht. Het is ten koste van je leven. Ze bouwen een monument voor je. ",
	)
...
def option_work_nachtrondes_met_harnas():
	...
	game_over(
		"Good ending",
		"Je heeft alle monster slachten door de nacht heen. Je krijgt een beloning een huis en een vaste baan. Ze bouwen een monument voor je ook. ",
	)
...
def dorp_gerudotown():
	print(
		"Jij hebt een meisje kleding nodig omdat gerudo is een vrouwen drop. Je hebt geen meisjes kleiding dus je hebt een keuze om eerst te werken of meteen de kleding kopen?"
	)
	print("A. Werken")
...
def option_enter_town():
	print(
		"Je komt de koningin Riju tegen, je zegt dat een woning zoek en ook werk. De koningin zegt dat je moet eerst werken om een huis te kopen. Wat wil je?"
	)
	print("A. Werken")
...
def option_work_buiten_gerudotown():
	print(
		"Je moet werken buiten de dorp en dat is op een oase gebied. Je krijgt de taak om kokosnoot op te halen bij de boom. Wat zou je doen ?"
	)
...
def option_asiel():
	print(
		"Jij hebt geen huis nog, maar jij hebt nu werk dus dat is prima. Je zit nu in een soort van asiel opvang. Maar je werk als dierverzorger en je hebt een dier kwijt. Wat ga je doen?"
	)
...
def option_fired():
	print(
		"Jij bent je baan kwijt maar je kan het terugverdienen door de dier te vinden. Wat zou je doen?"
	)
...
def option_animal_fake():
	print(
		"Jij koopt een andere dier in plaats van de dier zoeken. Je baas is er in getrapt. Nu hebt kan je een huis kopen. Ga je hier huis kopen of niet? J of N? "
	)
	option = input(">")
...
def option_house():
	global rupee
	print(
		"Gelukt, Jij hebt de dier gevonden en jij krijgt je eerste salaris. Jij kan nu een huis betalen. Niet alle huizen zijn gelijk dus je kan kiezen? Wat wil je?"
	)
	rupee[0] += 200
	...
	if option in answer_A:
		...
		if rupee2 > 200:
			...
			game_over(
				"Good ending",
				"Jij hebt een goede leven gehad in Gerudo, stabiele inkomen met een goede huis",
			)
		else:
			os.system("cls")
			print("Sorry jij hebt niet genoeg rupee")
		...
		if rupee2 > 200:
			...
			game_over(
				"Bad ending",
				"Jouw huis is niet sterk genoeg om te overleven en jij hebt niet een stabiele inkomenen",
			)
		else:
			os.system("cls")
			sleep(5)
...
def dorp_lurelinviliage():
	print(
		"Het is een prachtige strand dorp. Alles kunt je hier vinden. Je wilt eerst hier een werk zoeken. Wat voor werk zoek je?"
	)
...
def option_visser():
	rupee[0] += 100
	print(
		"Jij hebt de werk als visser aangenomen en jij hebt je aller eerste vis gepakt. Wat zou je doen?"
	)
	...
	if option in answer_A:
		...
		game_over(
			"Bad ending",
			"Je hebt genoeg eten voor dat dag maar je krijgt geen geld en daardoor kan je niet een huis bouwen en ben je dakloos",
		)
	elif option in answer_C:
		os.system("cls")
		option_sea()
...
def option_hotel_medewerker():
	rupee[0] += 100
	print(
		"Jij bent nu een hotel medewerker en een van je klant vroegt of je haar portefeuille gezien heeft. Je weet dat een collega heeft het gestolen. Wat zou je doen?"
	)
	...
	if option in answer_A:
		...
		game_over(
			"Good ending",
			"Jij vertelt tegen de klant dat je weet welke collega die haar portefeuille gestolen heeft en je krijgt geld beloning,vaste baan en ook een huis",
		)
	elif option in answer_B:
		os.system("cls")
		game_over(
			"Bad ending",
			"Jij heeft de klant niet verteld over je collega die de portefeuille gestolen heeft, de volgende dag het is bekend dat je collega heeft portefeuilie gestolen en hij geeft de schuld aan jou. En jij kan niet ermee weg.",
		)
	elif option in answer_C:
		os.system("cls")
		game_over(
			"Neutral ending",
			"Jij werkt nog en krijg een huis maar verder geen beloning",
		)
	else:
		os.system("cls")
		option_hotel_medewerker()
...
def option_boot_verhuurder():
	rupee[0] += 100
	print(
		"Jij bent nu boot verhuurder, Jij heeft nu een boot verhuurt aan een klant maar na 15 minuten de boot lekte. Wat zou je doen?"
	)
	...
	if option in answer_A:
		...
		game_over(
			"Bad ending",
			"De klant is al in de zeebodem toen je aan het hulp roepen. Jij bent gewoon je baan kwijt en dakloos",
		)
	elif option in answer_B:
		os.system("cls")
		game_over(
			"Good ending",
			"Gelukkig je kan hun redden binnen de tijd, je krijgt beloning en je kan huis kopen nu.",
		)
	elif option in answer_C:
		os.system("cls")
...
def option_sea():
	print(
		"Je zet de vis weer terug op de zee maar opeens de vis praat tegen jou en hij zal je 1 wens vervullen, wat voor wens maakt je dan?"
	)
	...
	if option in answer_A:
		...
		game_over(
			"Bad ending",
			"de vis vindt dat je te hebberig bent en hij vervult je wens niet",
		)
	elif option in answer_C:
		os.system("cls")
		option_markt()
...
def option_markt():
	print(
		"Jij verkoopt de vis, en krijgt genoeg geld om een huis te kopen. Zal je meer uitbreiden of ga je meteen huis kopen? "
	)
