...
correct_answer = ["IJmuiden", "Moeder", "Indonesie", "Mai Sakurajima"]
...
def anime():
    ...
    try:
        ...
        raise IndexError(
            "Sorry, it seems I can not find your character. Please restart the program manually."
        )
    print("-----------------------")
...
print("Hallo " + Name)
print(
    "I am a newcomer to the Mediacollege Amsterdam. To get to know me better, I ask a few questions about me."
)
time.sleep(5)
